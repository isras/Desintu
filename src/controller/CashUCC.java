...
public class CashUCC {

    /**
     * @web http://www.jc-mouse.net/
     * @author Mouse Clase original de javaface-elblogdelprogramador
     */
    public class JButtonCircle extends JButton {

        private Image image = null;
        private ImageIcon icono = new ImageIcon(getClass().getResource("/google/fotos/default.jpg"));
         ...
         * Constructor de clase
         *
         * @param coord de tipo Point Es la coordenada de la esquina superior
         * derecha del boton
         */
