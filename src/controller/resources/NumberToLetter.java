...
public class NumberToLetter {
    ...
    public String decena(int numero) {
    ...
    public String decimales(String dou) {
        String val = "";
        for (int i = 0; i < dou.length(); i++) {
            if (dou.charAt(i) == '.') {
                val = dou.substring(i + 1);
            }
        }
        if(val.equals("")){
            return "";
        ...
        if(nn == 0){
            ...
            return convertirLetras(nn);
        }        
    }
    public int parteDecimal(String dou){
        String val = "";
        for (int i = 0; i < dou.length(); i++) {
            if (dou.charAt(i) == '.') {
                val = dou.substring(i + 1);
    ...
    public String convertirALetras(double dou) {
        String caden = "";        
        int prim = (int) dou;
        if(prim==0){
            caden = "CERO";
        }else{
            caden = convertirLetras(prim);
        }        
        if (decimales(dou + "").equals("")) {
            caden = caden + " con 00 ctvs";
        } else {
            int part = parteDecimal(dou + "");
            String decim = "";
            if(part<10){
                decim = part+"0";
            }else{
            ...
            caden = caden + " con " + decim + " ctvs";
        }
        return caden;
    }
    
    //17-03-2013 to Los 17 dias del mes de Febrero del año dos mil trece
    public String convertDateToString(Date fecha){
        ...
        if(day==1){
            formato = "al, primer dia del mes de ";
        }else{
            formato = "a, los "+decena(day)+" dias del mes de ";
        }
                
        formato = formato + Operaciones.getMes(month)+" del año "+miles(year)+".";                                    
